...
// 
// s - Manager.cpp
extern const Color InstructionsBackButton;  // {162, 59, 85, 255}
extern const Color ReplayButtonHover;       // {100, 200, 100, 255}
extern const Color ReplayButtonGlow;        // {100, 255, 100, 100}
extern const Color MenuButtonHover;         // {200, 100, 100, 255}
extern const Color MenuButtonGlow;          // {255, 100, 100, 100}
