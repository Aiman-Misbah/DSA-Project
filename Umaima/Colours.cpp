...
const Color TetrisRed = { 246, 143, 142, 255 };             // From WelcomeScreen.cpp
const Color TetrisGreen = { 87, 247, 87, 255 };           // From WelcomeScreen.cpp
const Color TetrisBlue = { 87, 87, 247, 255 };            // From WelcomeScreen.cpp
const Color TetrisYellow = { 248, 225, 125, 255 };         // From WelcomeScreen.cpp
...
// ============ ADD THESE NEW GAME OVER COLORS ============
const Color GameOverDarkBlue = { 25, 35, 65, 245 };      // Dark panel background
const Color GameOverBrightRed = { 255, 60, 60, 255 };    // Title color
const Color GameOverBrightCyan = { 80, 220, 255, 255 };  // Score color
const Color GameOverPurple = { 180, 80, 220, 255 };      // Menu button
const Color GameOverPurpleHover = { 220, 120, 255, 255 };// Menu button hover
const Color GameOverTextWhite = { 240, 240, 255, 255 };  // White text with blue tint
const Color GameOverLineGold = { 255, 215, 0, 100 };     // Gold separator lines
// Add this to Colours.cpp (with the other Game Over colors):
const Color GameOverBestScoreGold = { 255, 215, 0, 255 };     // Pure gold for best score
